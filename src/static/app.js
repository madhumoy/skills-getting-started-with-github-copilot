      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        const participantsMarkup = details.participants.length
          ? details.participants
              .map(
                p =>
                  `<li class="participant-item">${p}<span class="delete-icon" data-email="${p}" data-activity="${name}">&times;</span></li>`
              )
              .join("")
          : '<li><em>No one has signed up yet</em></li>';
        ...
        // Add delete listeners for this card immediately
  ...
  signupForm.addEventListener("submit", async (event) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // refresh the activities list so the participants update
        fetchActivities();
      } else {
